...
html {height: 100%;}
body{}
form{ padding-top:190px; padding-bottom: 20px;}
@media screen and (max-width:699px){  
  html {height: 100%; background-color: #1a76d6;}
  body{background:url(theme/default/images/main/loginbg2.png) no-repeat center top; height: 100%;}  
  .table-4{width:200px;}
}  
@media screen and (min-width:700px){  
  html {height: 100%; background-color: #06294e;}
  body{background:url(theme/default/images/main/loginbg.png) no-repeat center top; height: 100%;}
  .table-4{width:480px;}
} 
