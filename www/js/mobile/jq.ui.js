...
(function($) {
	...
	var scroller = (function() {
		...
		jsScroller.prototype.onTouchStart = function(event) {
            console.log('jsScroller.onTouchStart');
			this.moved = false;
			this.currentScrollingObject = null;
		...
		jsScroller.prototype.onTouchMove = function(event) {
            console.log('jsScroller.onTouchMove');
		...
		jsScroller.prototype.doScroll = function() {
            console.log('jsScroller.doScroll');
		...
		jsScroller.prototype.calculateMovement = function(event, last) {
            ...
            var deltaX = pageX - prevEventInfo.pageX;
            var deltaY = pageY - prevEventInfo.pageY;

            //设置只能纵向或横向滚动
			scrollInfo.deltaY = this.elementInfo.hasVertScroll ? deltaY : 0;
			scrollInfo.deltaX = this.elementInfo.hasHorScroll ? deltaX : 0;
		...
		jsScroller.prototype.onTouchEnd = function(event) {
            console.log('jsScroller.onTouchEnd');
    ...
    ui.prototype = {
        ...
        */
        ...
        launch: function() {
            ...
            maskDiv.innerHTML = "<span class='ui-icon ui-icon-loading spin'></span><h1>加载中</h1>";
